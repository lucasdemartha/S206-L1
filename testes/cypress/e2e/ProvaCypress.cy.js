...
describe('Criando o cenário de teste para o site globalsqa',( ) => {
  ...
  it('Caso de teste: Logando um usuário que acabou de ser registrado no site com sucesso.', () => {
    ...
    it('Caso de teste: Verificando no banco de dados se o usuário foi registrado.', () => {
      let info = criarUsuario()
